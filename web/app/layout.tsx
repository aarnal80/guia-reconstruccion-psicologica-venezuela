...
export const metadata: Metadata = {
  ...
  title: {
    default: "Guía de reconstrucción psicológica",
    template: "%s · Guía de reconstrucción psicológica",
  },
  description:
  ...
  applicationName: "Guía de reconstrucción psicológica",
  authors: [
  ...
  openGraph: {
    ...
    description: "Cuando todo se derrumba por dentro y por fuera.",
    images: [
      {
        url: "./og.png",
        width: 1536,
        height: 804,
        alt: "Guía de reconstrucción psicológica para Venezuela",
      },
    ],
  },
  twitter: {
